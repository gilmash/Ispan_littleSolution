...
namespace ISpan
{
    public partial class EditProductForm : Form
    {
        ...
        private void BindData(int id)
        {
            ...
            productNameTextBox.Text = model.ProductsName;
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            int price = priceTextBox.Text.ToInt(-1); //如果没填,傳回-1
            ...
            if (string.IsNullOrEmpty(model.ProductsName)) errorMsg += "店家名稱必填\r\n";
            if (string.IsNullOrEmpty(model.ProductsName)) errorMsg += "產品名稱必填\r\n";
			...
			SET CategoryId=@CategoryId, StoreName=@StoreName,ProductsName=@ProductsName, Price = @Price
			WHERE Id=@Id";

            var parameters = new SqlParameterBuilder()
                .AddNInt("CategoryId", model.CategoryId)
                .AddNVarchar("StoreName",50,model.StoreName)
                .AddNVarchar("ProductsName", 50, model.ProductsName)
                .AddNInt("Price", model.Price)
                .AddNInt("Id", this.id)
                .Build();
