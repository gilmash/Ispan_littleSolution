...
namespace ISpan
{
    public partial class AddProductForm : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            string productsName = productNameTextBox.Text;
            int Price = listPriceTextBox.Text.ToInt(-1); //如果没填牌價,傳回-1
            ...
            if (string.IsNullOrEmpty(model.StoreName)) errorMsg += "店家名稱必填\r\n";
...
(CategoryId,StoreName,ProductsName, Price)
VALUES
(@CategoryId,@StoreName,@ProductsName, @Price)";
